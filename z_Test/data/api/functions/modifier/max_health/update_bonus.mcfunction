...
# 差分にする
    scoreboard players operation $Diff Temporary = @s 02.Bonus.01.Health
...
# 適用
    ...
    scoreboard players operation $Amount Temporary = @s 02.Bonus.01.Health
    execute store result storage api: Argument.Amount double 1 run scoreboard players operation $Amount Temporary += $BonusHealth Global
