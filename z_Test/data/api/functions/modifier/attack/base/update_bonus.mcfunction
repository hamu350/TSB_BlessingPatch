...
# 差分にする
    scoreboard players operation $Diff Temporary = @s 02.SelectCount.03.Attack
...
# 適用
    ...
    execute store result storage api: Argument.Amount double 0.01 run scoreboard players get @s 02.SelectCount.03.Attack
