...
# 出力
    ...
    execute unless score @s 02.SelectBonusSum.01.MaxHealth matches -2147483648..2147483647 run scoreboard players set @s 02.SelectBonusSum.01.MaxHealth 0
    execute unless score @s 02.SelectBonusSum.02.MaxMP matches -2147483648..2147483647 run scoreboard players set @s 02.SelectBonusSum.02.MaxMP 0
    execute unless score @s 02.SelectBonusSum.03.Attack matches -2147483648..2147483647 run scoreboard players set @s 02.SelectBonusSum.03.Attack 0
    execute unless score @s 02.SelectBonusSum.04.Defense matches -2147483648..2147483647 run scoreboard players set @s 02.SelectBonusSum.04.Defense 0
    execute unless score @s 02.SelectBonusSum.05.FallResistance matches -2147483648..2147483647 run scoreboard players set @s 02.SelectBonusSum.05.FallResistance 0
    execute unless score @s 02.Bonus.01.Health matches -2147483648..2147483647 run scoreboard players set @s 02.Bonus.01.Health 0
    execute unless score @s 02.Bonus.02.MP matches -2147483648..2147483647 run scoreboard players set @s 02.Bonus.02.MP 0
...
# text data
    ...
    data modify storage temp: Text.SelectMax1 set value [{"text":" "}, {"text":"[MAX]","clickEvent":{"action":"run_command","value":"/trigger 02.Trigger set 101"},"color":"gold"}]
    data modify storage temp: Text.SelectMax2 set value [{"text":" "}, {"text":"[MAX]","clickEvent":{"action":"run_command","value":"/trigger 02.Trigger set 102"},"color":"gold"}]
    data modify storage temp: Text.SelectMax3 set value [{"text":" "}, {"text":"[MAX]","clickEvent":{"action":"run_command","value":"/trigger 02.Trigger set 103"},"color":"gold"}]
    data modify storage temp: Text.SelectMax4 set value [{"text":" "}, {"text":"[MAX]","clickEvent":{"action":"run_command","value":"/trigger 02.Trigger set 104"},"color":"gold"}]
    data modify storage temp: Text.SelectMax5 set value [{"text":" "}, {"text":"[MAX]","clickEvent":{"action":"run_command","value":"/trigger 02.Trigger set 105"},"color":"gold"}]
    ...
    data modify storage temp: Text.MaxValue4 set value {"score": {"name": "$4", "objective": "02.MaxValue"}, "color": "aqua"}
    data modify storage temp: Text.MaxValue5 set value {"score": {"name": "$5", "objective": "02.MaxValue"}, "color": "aqua"}
    ...
    data modify storage temp: Text.Score1 set value {"score": {"name": "@s","objective": "02.SelectBonusSum.01.MaxHealth"},"color": "aqua"}
    data modify storage temp: Text.Score2 set value {"score": {"name": "@s","objective": "02.SelectBonusSum.02.MaxMP"},"color": "aqua"}
    data modify storage temp: Text.Score3 set value {"score": {"name": "@s","objective": "02.SelectBonusSum.03.Attack"},"color": "aqua"}
    data modify storage temp: Text.Score4 set value {"score": {"name": "@s","objective": "02.SelectBonusSum.04.Defense"},"color": "aqua"}
    data modify storage temp: Text.Score5 set value {"score": {"name": "@s","objective": "02.SelectBonusSum.05.FallResistance"},"color": "aqua"}
    ...
    # 選択回数が最大取得数以上なら選択不能になる
        ...
        execute if score @s 02.SelectCount.01.MaxHealth >= $1 02.MaxUse run data modify storage temp: Text.Score1."color" set value "yellow"
        ...
        execute if score @s 02.SelectCount.02.MaxMP >= $2 02.MaxUse run data modify storage temp: Text.Score2."color" set value "yellow"
        ...
        execute if score @s 02.SelectCount.03.Attack >= $3 02.MaxUse run data modify storage temp: Text.Score3."color" set value "yellow"
    ...
    # 実際のメッセージ
        data modify storage temp: Text.Message1 set value '{"translate": "%1$s §f%3$s%4$s+%5$s §f(合計%4$s+%6$s%4$s/%4$s§f%7$s)%2$s", "with": [{"storage":"temp:","nbt":"Text.Select1","interpret": true},{"storage":"temp:","nbt":"Text.SelectMax1","interpret": true},{"storage":"temp:","nbt":"Text.Name1","interpret": true},{"text":"\\u0002","font":"space"},{"storage":"temp:","nbt":"Text.Value1","interpret": true},{"storage":"temp:","nbt":"Text.Score1","interpret": true},{"storage":"temp:","nbt":"Text.MaxValue1","interpret": true}]}'
        data modify storage temp: Text.Message2 set value '{"translate": "%1$s §f%3$s%4$s+%5$s §f(合計%4$s+%6$s%4$s/%4$s§f%7$s)%2$s", "with": [{"storage":"temp:","nbt":"Text.Select2","interpret": true},{"storage":"temp:","nbt":"Text.SelectMax2","interpret": true},{"storage":"temp:","nbt":"Text.Name2","interpret": true},{"text":"\\u0002","font":"space"},{"storage":"temp:","nbt":"Text.Value2","interpret": true},{"storage":"temp:","nbt":"Text.Score2","interpret": true},{"storage":"temp:","nbt":"Text.MaxValue2","interpret": true}]}'
        data modify storage temp: Text.Message3 set value '{"translate": "%1$s §f%3$s%4$s+%5$s §f(合計%4$s+%6$s%4$s/%4$s§f%7$s)%2$s", "with": [{"storage":"temp:","nbt":"Text.Select3","interpret": true},{"storage":"temp:","nbt":"Text.SelectMax3","interpret": true},{"storage":"temp:","nbt":"Text.Name3","interpret": true},{"text":"\\u0002","font":"space"},{"storage":"temp:","nbt":"Text.Value3","interpret": true},{"storage":"temp:","nbt":"Text.Score3","interpret": true},{"storage":"temp:","nbt":"Text.MaxValue3","interpret": true}]}'
        data modify storage temp: Text.Message4 set value '{"translate": "%1$s §f%3$s%4$s+%5$s §f(合計%4$s+%6$s%4$s/%4$s§f%7$s)%2$s", "with": [{"storage":"temp:","nbt":"Text.Select4","interpret": true},{"storage":"temp:","nbt":"Text.SelectMax4","interpret": true},{"storage":"temp:","nbt":"Text.Name4","interpret": true},{"text":"\\u0002","font":"space"},{"storage":"temp:","nbt":"Text.Value4","interpret": true},{"storage":"temp:","nbt":"Text.Score4","interpret": true},{"storage":"temp:","nbt":"Text.MaxValue4","interpret": true}]}'
        data modify storage temp: Text.Message5 set value '{"translate": "%1$s §f%3$s%4$s+%5$s §f(合計%4$s+%6$s%4$s/%4$s§f%7$s)%2$s", "with": [{"storage":"temp:","nbt":"Text.Select5","interpret": true},{"storage":"temp:","nbt":"Text.SelectMax5","interpret": true},{"storage":"temp:","nbt":"Text.Name5","interpret": true},{"text":"\\u0002","font":"space"},{"storage":"temp:","nbt":"Text.Value5","interpret": true},{"storage":"temp:","nbt":"Text.Score5","interpret": true},{"storage":"temp:","nbt":"Text.MaxValue5","interpret": true}]}'
