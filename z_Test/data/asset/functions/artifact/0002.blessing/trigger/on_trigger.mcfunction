...
# 1 体力
    ...
    execute if score @s 02.Trigger matches 1 run scoreboard players operation @s 02.SelectBonusSum.01.MaxHealth += $1 02.Value
...
# 2 MP
    ...
    execute if score @s 02.Trigger matches 2 run scoreboard players operation @s 02.SelectBonusSum.02.MaxMP += $2 02.Value
...
# 3 攻撃
    ...
    execute if score @s 02.Trigger matches 3 run scoreboard players operation @s 02.SelectBonusSum.03.Attack += $3 02.Value
...
# 4 防御
    ...
    execute if score @s 02.Trigger matches 4 run scoreboard players operation @s 02.SelectBonusSum.04.Defense += $4 02.Value
...
# 5 落下耐性
    ...
    execute if score @s 02.Trigger matches 5 run scoreboard players operation @s 02.SelectBonusSum.05.FallResistance += $5 02.Value
