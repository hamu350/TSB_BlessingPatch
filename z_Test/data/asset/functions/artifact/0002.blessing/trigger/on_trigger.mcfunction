...
# 1 体力
    ...
    execute if score @s 02.Trigger matches 1 run scoreboard players add @s 02.Bonus.01.Health 2
    execute if score @s 02.Trigger matches 1 run scoreboard players add @s 02.SelectBonusSum.01.MaxHealthSelect 2
...
# 2 MP
    ...
    execute if score @s 02.Trigger matches 2 run scoreboard players add @s 02.Bonus.02.MP 4
    execute if score @s 02.Trigger matches 2 run scoreboard players add @s 02.SelectBonusSum.02.MaxMPSelect 4
...
# 3 攻撃
    ...
    execute if score @s 02.Trigger matches 3 run scoreboard players add @s 02.Bonus.03.Attack 1
...
# 4 防御
    ...
    execute if score @s 02.Trigger matches 4 run scoreboard players add @s 02.Bonus.04.Defense 1
...
# 5 落下耐性
    ...
    execute if score @s 02.Trigger matches 5 run scoreboard players add @s 02.Bonus.05.FallResistance 5
