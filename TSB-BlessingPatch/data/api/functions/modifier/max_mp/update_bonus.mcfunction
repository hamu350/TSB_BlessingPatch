...
# 差分にする
    ...
    execute store result score $Bonus Temporary run data get storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].BlsPatch.Bonus[02]
...
# 適用
    ...
    execute store result storage api: Argument.Amount double 1 run scoreboard players operation $Bonus Temporary += $BonusMP Global
